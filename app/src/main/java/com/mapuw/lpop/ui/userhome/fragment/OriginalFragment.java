package com.mapuw.lpop.ui.userhome.fragment;
 ...
 * {@link OriginalFragment.OnFragmentInteractionListener} interface
...
public class OriginalFragment extends Fragment {
    ...
    public static OriginalFragment newInstance(User user) {
