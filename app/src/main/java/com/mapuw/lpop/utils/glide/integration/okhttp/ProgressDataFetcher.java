...
public class ProgressDataFetcher implements DataFetcher<InputStream> {
    ...
    public InputStream loadData(Priority priority) throws Exception {
        ...
        OkHttpClient client = new OkHttpClient().newBuilder()
                .addNetworkInterceptor(new ProgressInterceptor(getProgressListener()))
                .build();

//        client.newBuilder().addNetworkInterceptor(new ProgressInterceptor(getProgressListener()));
//        client.newBuilder().addInterceptor(new ProgressInterceptor(getProgressListener())).build();
