...
public class Emoticons {
    ...
    static {
        ...
        emojiMap.put("[哆啦A梦吃惊]", "dorachijing_mobile");
        emojiMap.put("[哆啦A梦微笑]", "jqmweixiao_mobile");
        emojiMap.put("[哆啦A梦花心]", "dorahaose_mobile");
        emojiMap.put("[哆啦A梦汗]", "doraemon_han");

        emojiMap.put("[带着微博去旅行]", "hl_d_lvxing");
